...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.faceUp) {
        ...
        if ([[self rankAsString] isEqualToString:@"joker"]) {
            nameForImage = [NSString stringWithFormat:@"%@-?-75.png", [self rankAsString]];
        } else {
            nameForImage = [NSString stringWithFormat:@"%@-%@-75.png", self.suit, [self rankAsString]];
        }
        
        UIImage *faceImage = [UIImage imageNamed:nameForImage];
        if (faceImage) {
